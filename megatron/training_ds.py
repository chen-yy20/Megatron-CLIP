...
def pretrain(train_valid_test_dataset_provider,
    ...
    config = get_origin_model_config(model_provider, model_type)
...
_MODEL_CONFIG = None
def get_origin_model_config(model_provider_func=None,
                              model_type=None,):
...
def setup_model_and_optimizer(model_provider_func,
    ...
    # initialize the compression heres
...
def training_log(loss_dict, total_loss_dict, learning_rate, iteration,
    ...
    if False and iteration % args.tensorboard_log_interval == 0:
