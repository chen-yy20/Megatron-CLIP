...
def main(args):
    ...
    if args.enable_deepspeed:
        print_rank_0("\n\nEnable Deepspeed\n\n")
        # replaced with deepspeed distributed init
    ...
    if args.distributed and not args.horovod and not args.enable_deepspeed:
        if args.use_bn_sync:
        ...
        model = torch.nn.parallel.DistributedDataParallel(model, device_ids=[device], static_graph=True, **ddp_args)
    ...
    if args.train_data or args.dataset_type == "synthetic":
        ...
        # disable scaler for compatiable with Deepspeed
